...
data = sparkConf.read.format("csv").option("header", "true").option("delimiter", ",").load("dataset_clean_full.csv")
...
plt.plot(range(2, 8), kmeansScores, 'ro')
